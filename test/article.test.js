...
describe("Tests sur les Articles", () => {
    it("Créer un article valide", () => {
        const article = new Article(1, "Fraises", 2.5, 25, new Date("2024-05-10"));
    ...
    it("Créer un article avec un id égal à 0", () => {
        expect(() => new Article(0, "", 2.5, 25, new Date("2024-05-10"))).to.throw("Invalid id provided");
    });

    it("Créer un article avec un id inférieur à 0", () => {
        expect(() => new Article(-10, "", 2.5, 25, new Date("2024-05-10"))).to.throw("Invalid id provided");
    });

    it("Créer un article avec un nom invalide", () => {
        expect(() => new Article(1, "", 2.5, 25, new Date("2024-05-10"))).to.throw("Invalid name provided");
    });

    it("Créer un article avec un prix égal à 0", () => {
        expect(() => new Article(1, "Fraises", 0, 25, new Date("2024-05-10"))).to.throw("Invalid price provided");
    });

    it("Créer un article avec un prix négatif", () => {
        expect(() => new Article(1, "Fraises", -10, 25, new Date("2024-05-10"))).to.throw("Invalid price provided");
    });

    it("Créer un article avec une quantité égale à 0", () => {
        expect(() => new Article(1, "Fraises", 2.5, 0, new Date("2024-05-10"))).to.throw("Invalid quantity provided");
    });

    it("Créer un article avec une quantité négative", () => {
        expect(() => new Article(1, "Fraises", 2.5, -10, new Date("2024-05-10"))).to.throw("Invalid quantity provided");
    });
    ...
    it("Retirer une quantité valide et précise à un article", () => {
        const article = new Article(1, "Fraises", 5, 11, new Date("2024-05-10"));
    ...
    it("Retirer une quantité supérieure à la quantité de l'article", () => {
        const article = new Article(1, "Fraises", 5, 5, new Date("2024-05-10"));
    ...
    it("Créer un article avec une remise invalide", () => {
        const article = new Article(1, "Fraises", 5, 1, new Date("2024-05-10"));
    ...
    it("Créer un article avec 2 ou plus en quantité et une réduction valide", () => {
        const article = new Article(1, "Fraises", 5, 7, new Date("2024-05-10"));
        article.setDiscount(50);
